...
def exportReports():
    ...
    with Gmp(connection, transform=transform) as gmp:
        ...
        for reportID in getReports:
            ...
            reportscv = gmp.get_report(reportID, report_format_id=reportFormatID, filter="apply_overrides=0 min_qod=70",
                                       ignore_pagination=True, details=True)
            # pretty_print(reportscv)
            resultID = reportscv.get_reports_response.report['id']
